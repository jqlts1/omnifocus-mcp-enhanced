  ...
  ${datePreamble}try
    tell application "OmniFocus"
      tell front document
        ...
        ${dueDateCode ? `set due date of newTask to dueDateVal` : ''}
        ${deferDateCode ? `set defer date of newTask to deferDateVal` : ''}
        ${plannedDateCode ? `set planned date of newTask to plannedDateVal` : ''}
