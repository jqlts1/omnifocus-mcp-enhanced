...
export const schema = z.object({
  perspectiveName: z
    .string()
    .describe(
      "Exact name of the OmniFocus custom perspective (e.g., '今日工作安排', '今日复盘', '本周项目'). This is NOT a tag name.",
    ),
  hideCompleted: z
    .boolean()
    .optional()
  ...
  showHierarchy: z
    ...
    .optional()
    .describe(
      "Display tasks in hierarchical tree structure showing parent-child relationships. Use this when user wants '层级显示' or 'tree view' (default: false)",
    ),
  groupByProject: z
    .boolean()
    .optional()
