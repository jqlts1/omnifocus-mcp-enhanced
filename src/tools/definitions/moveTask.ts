...
export const schema = z.object({
  ...
  name: z
    .string()
    .optional()
    .describe('The name of the task to move (fallback if ID not provided)'),
  targetProjectId: z.string().optional().describe('Destination project ID'),
  targetProjectName: z
    .string()
    .optional()
    .describe('Destination project name (errors on duplicate names)'),
  targetParentTaskId: z
    .string()
    .optional()
    .describe('Destination parent task ID'),
  targetParentTaskName: z
    .string()
    .optional()
    .describe('Destination parent task name (errors on duplicate names)'),
